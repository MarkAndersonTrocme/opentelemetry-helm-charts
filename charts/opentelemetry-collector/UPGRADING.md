...
Resource `limits` have been reduced. Upgrades/installs of chart 1.0.0 will now use fewer resources. In order to set the resources back to what they where, you will need to override the `resources` section in the `values.yaml`.
